...
export const ProductTypeUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="greenFirmHouseApp.productType.home.createOrEditLabel" data-cy="ProductTypeCreateUpdateHeading">
