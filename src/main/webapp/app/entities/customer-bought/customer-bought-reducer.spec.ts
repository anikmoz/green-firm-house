...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMERBOUGHT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CUSTOMERBOUGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMERBOUGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMERBOUGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMERBOUGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMERBOUGHT actions', async () => {
      const expectedActions = [
        {
